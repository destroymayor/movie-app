...
const Sliders = (props) => {
  ...
  return (
    <div className="flex items-center" style={{ width: '97vw' }}>
      {isPreviousEnd && (
        <button
          className="absolute left-1 z-10 h-1/3 rounded-md p-1 hidden sm:block text-yellow-500 transition duration-200 ease-in-out hover:text-yellow-600 hover:bg-gray-200"
      ...
      <div className="relative overflow-x-scroll sm:overflow-hidden ml-10 mr-14">
        <ul
      ...
      {isNextEnd && (
        <button
          className="absolute right-1 z-10 h-1/3 rounded-md p-1 hidden sm:block text-yellow-500 transition duration-200 ease-in-out hover:text-yellow-600 hover:bg-gray-200"
